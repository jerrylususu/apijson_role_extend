...
--
-- Host: 192.168.99.100    Database: apijson_role_extend
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='权限配置(必须)';
...
INSERT INTO `Access` VALUES (1,0,'Course','','[ \"STUDENT\", \"TEACHER\", \"PRINCIPAL\" ]','[ \"STUDENT\", \"TEACHER\",\"PRINCIPAL\" ]','[\"STUDENT\", \"TEACHER\",\"PRINCIPAL\" ]','[\"STUDENT\", \"TEACHER\",\"PRINCIPAL\" ]','[\"TEACHER\"]','[\"OWNER\",\"PRINCIPAL\"]','[\"TEACHER\"]','2018-11-28 16:28:53',NULL),(2,0,'User',NULL,'[\"LOGIN\", \"CONTACT\", \"CIRCLE\", \"OWNER\", \"ADMIN\"]','[\"LOGIN\", \"CONTACT\", \"CIRCLE\", \"OWNER\", \"ADMIN\"]','[\"UNKNOWN\", \"LOGIN\", \"CONTACT\", \"CIRCLE\", \"OWNER\", \"ADMIN\"]','[\"UNKNOWN\", \"LOGIN\", \"CONTACT\", \"CIRCLE\", \"OWNER\", \"ADMIN\"]','[\"OWNER\", \"ADMIN\"]','[\"OWNER\", \"ADMIN\"]','[\"OWNER\", \"ADMIN\"]','2021-07-28 14:02:41',' '),(3,0,'Credential',NULL,'[]','[]','[\"UNKNOWN\",\"OWNER\", \"ADMIN\"]','[\"OWNER\", \"ADMIN\"]','[\"UNKNOWN\",\"LOGIN\",\"OWNER\", \"ADMIN\"]','[\"OWNER\", \"ADMIN\"]','[\"ADMIN\"]','2021-07-28 14:04:01',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=1627772410503 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Course` VALUES (1,1,'CS102','Java','二教403',59),(1627249802854,1,'CS103','Rust','一教222',100),(1627252238116,3,'CS108','OS','机房203',20),(1627424662423,3,'CS109','DB','一教222',222),(1627771947679,3,'CS244','分布式系统','二教222',80);
...
INSERT INTO `Credential` VALUES (1,'1234','[\"STUDENT\", \"TEACHER\"]'),(2,'1234','[\"STUDENT\"]'),(3,'1234','[\"TEACHER\"]'),(4,'1234','[\"PRINCIPAL\"]');
...
CREATE TABLE `Function` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='远程函数。强制在启动时校验所有demo是否能正常运行通过';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Request` VALUES (1,1,'POST','Course','{\"MUST\": \"sysid,name,teacher,location,capacity\", \"REFUSE\": \"id\"}','添加课程','2021-07-25 21:37:20'),(2,1,'PUT','Course','{\"MUST\": \"id\"}','修改课程','2021-07-31 23:06:15'),(3,1,'DELETE','Course','{\"MUST\": \"id\", \"REFUSE\": \"!\"}','移除课程','2021-07-31 23:06:15');
...
INSERT INTO `User` VALUES (1,'jerry','jerrylu','a teacher'),(2,'neko','neko','a student'),(3,'doge','doge','another teacher'),(4,'principal','principal','principal');
...
-- Dump completed on 2021-08-01 15:54:35
